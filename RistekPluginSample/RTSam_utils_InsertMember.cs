...
{
    public class ParametricTrussInsertMemberObjectMyHelper
    {

        #region base

        public BeamTrussToolRSTSamBaseInsertMember m_trussToolPassed { get; private set; }
        public ParametricTrussInsertMemberObjectMyHelper(BeamTrussToolRSTSamBaseInsertMember _trussToolIntegrated)
        {
        ...
        public ParametricTrussRTSamInsertMember GenerateParametricTruss(BeamTrussToolRSTSamBaseInsertMember trussTool, double height, Point3D origin, Point3D directionPoint)
        //public ParametricTrussRTSam GenerateParametricTruss(ref BeamTrussToolRSTSamBase trussTool, double height, Point3D origin, Point3D directionPoint)
        {
            ...
            ParametricTrussRTSamInsertMember truss;
            if (!this.m_trussToolPassed.Flag_isRistekPlugin_isKnagaMode)
            {
                truss = new ParametricTrussRTSamInsertMember(Strings.Strings._beamTrussNodeName);
            }
            else //if (this.m_trussToolPassed.Flag_isRistekPlugin_isKnagaMode)
            {
                truss = new ParametricTrussRTSamInsertMember(Strings.Strings._beamTrussKnagaNodeName);
            }
