...
{
    // workaround (trial and error) - dll has to have in it a class derived from PluginTool for the plugin system to search plugins in it
    public class RistekPluginFakeClass : PluginTool
    {
        public override string NameForMenu { get { return Strings.Strings.adm_sample_plugin_member + " FAKE"; } }
        public override Type AcceptedMasterNodeType { get { return typeof(MyUtils); } }
        public override object MenuToolTip { get { return null; } }
    ...
    public class AdmSamplePlugin : Epx.Ristek.ParametricTrusses.PluginParametricTrusses.BeamTruss,
        IModelViewPlugin,
        IRibbonViewPlugin, IRibbonDialogPlugin,
        ...
        */
        ...
        public override string NameForMenu
        {
            get
            {
                ...
                return Strings.Strings.adm_sample_plugin_member;
            }
        }
        ...
        public override object MenuToolTip
        {
            get
            {
                return Strings.Strings._MenuToolTip;
            }
        }
        ...
        protected override void InitializeMyTrussProperties(ParametricTrussRTSam initializationTruss)
        {
        ...
        public ParametricTrussRTSam GenerateBeamTrussNewBase(ParametricTrussMyHelper trussMyHelper, out (Vector3D, Vector3D, Vector3D) newTrussPlainTupleNormalizeNot)
        {
            ...
            */
            ...
            foreach (int i in new int[] { 0, 1 })
            {
                ...
                if (!this.Flag_isRistekPlugin_isKnagaMode)
                {
                    ...
                    */
                    foreach (Member _memberCurr in _ptCurr.GetMembers())
                    {
                        if (true
                            //&& _memberCurr != _m_i
            ...
            */
            ...
            Point3D _newPlainPoint1 = reachPointExtracionList_inGlobal_[0].Item2.Item1;
            Point3D _newPlainPoint2 = reachPointExtracionList_inGlobal_[0].Item2.Item2;
            Point3D _newPlainPoint3 = reachPointExtracionList_inGlobal_[1].Item2.Item2;
            Vector3D pt0_p1_to_p2_vectorNormalized = (_newPlainPoint2 - _newPlainPoint1);
            pt0_p1_to_p2_vectorNormalized.Normalize();
            Vector3D pt0_p2_to_p1_vectorNormalized_ = (_newPlainPoint1 - _newPlainPoint2);
            pt0_p2_to_p1_vectorNormalized_.Normalize();
            Point3D _newPlainPoint1_Used = _newPlainPoint1;
            ...
            // 20240328 Knaga
            Point3D _newPlainPoint2_Used_ = MyUtils.TranslatePoint(_newPlainPoint2, pt0_p2_to_p1_vectorNormalized_,
            ...
            (Vector3D, Vector3D, Vector3D) _plainTup = MyUtils.DeterminePlaneAxes(_newPlainPoint1_Used, _newPlainPoint2_Used_, _newPlainPoint3);
            newTrussPlainTupleNormalizeNot = _plainTup;
            Vector3D planeNormalToFutureBeamTruss = MyUtils.CalculateNormal(_newPlainPoint1, _newPlainPoint2, _newPlainPoint3);
            planeNormalToFutureBeamTruss.Normalize();

            //double _elevation_t = _m0_.Width / 2.0;

            double _elevation_t = 0;
            Point3D _newPlainOriginPointElevatedUp = MyUtils.ElevateOriginGlobalWithForcedDirectionZ(newTrussPlainTupleNormalizeNot.Item1, newTrussPlainTupleNormalizeNot.Item2, newTrussPlainTupleNormalizeNot.Item3, _newPlainPoint1_Used, _elevation_t, getReferenceEnforcementDirectionVector(), MyUtils.EnforceElevationVectorEnum.enforcePositive);
            Point3D _newPlainDestinationPointElevatedUp_ = MyUtils.ElevateOriginGlobalWithForcedDirectionZ(newTrussPlainTupleNormalizeNot.Item1, newTrussPlainTupleNormalizeNot.Item2, newTrussPlainTupleNormalizeNot.Item3, _newPlainPoint2_Used_, _elevation_t, getReferenceEnforcementDirectionVector(), MyUtils.EnforceElevationVectorEnum.enforcePositive);

            Vector3D _futureBeamTrussVectorPlane = MyUtils.CalculateNormal(planeNormalToFutureBeamTruss, _newPlainPoint1, _newPlainPoint2);
            ...
            Point3D _newPlainOriginPointElevatedUp_andMovedToPartner = MyUtils.TranslatePoint(_newPlainOriginPointElevatedUp, _futureBeamTrussVectorPlane, _m0_thicknessAdjustment);
            Point3D _newPlainDestinationPointElevatedUp_andMovedToPartner_ = MyUtils.TranslatePoint(_newPlainDestinationPointElevatedUp_, _futureBeamTrussVectorPlane, _m0_thicknessAdjustment);
        ...
        ParametricTrussMyHelper m_resTrussMyHelper = null;
        //internal ParametricTrussRTSam m_resTrussStorage = null;
        internal ParametricTrussRTSam m_resTrussStorageHidden;
        internal ParametricTrussRTSam m_resTrussStorage
        {
            get
            {
                if (!this.IsInEditMode
        ...
        internal ParametricTrussRTSam m_resTrussStorage_RawReferential = null;
        ...
        public ParametricTruss getBeamTrussLocationAdjustedSingletonOrFetched(bool forceRegenerateMainTruss = false)
        {
                ...
                )
            {
                if (!this.IsInEditMode)
                {
                    ...
                    BeamTrussToolRSTSamBase m_trussToolTmp = this;
                    ParametricTrussMyHelper _resTrussMyHelperTmp = new ParametricTrussMyHelper(m_trussToolTmp);
                    (Vector3D, Vector3D, Vector3D) _newTrussPlainTupleNormalizeNotTmp;
                    ParametricTrussRTSam _ptNewRawReferential = GenerateBeamTrussNewBase(_resTrussMyHelperTmp, out _newTrussPlainTupleNormalizeNotTmp);

                    m_resTrussStorage_RawReferential = _ptNewRawReferential;

                    ParametricTrussMyHelper _resTrussMyHelper = new ParametricTrussMyHelper(this);
                    ParametricTrussRTSam _ptNew = GenerateBeamTrussNewBase(_resTrussMyHelper, out this.m_newTrussPlainTupleNormalizeNot);
        ...
        {
            ParametricTrussRTSam _ptUsed = this.m_ParametricTrussRTSamCurrent;
            AdmSamplePlugin _trussTool = this;
        ...
        public List<Support> updateBeamTrussSupportsGlobal(bool doNotRecover = true, bool isForUndo = false)
        {
            ...
            if (m_getBeamTrussSupportsGlobal == null
                || !doNotRecover
                )
            {
                ...
                if (doNotRecover)
                {
                    ...
                    else
                    {
...

                        {
                            ...
                            _support2.Alignment = Epx.BIM.Models.Model3DNode.ModelPartAlignment.TopRight;
            ...
            ParametricTrussRTSam _ptFetched;
            if (!isForUndo)
            {
                AdmSamplePlugin _resTrussTool = this;
        ...
        {
            ParametricTrussRTSam _resTruss = this.m_ParametricTrussRTSamCurrent;
            AdmSamplePlugin _trussTool = this;
        ...
        protected string getRecordInMyDataInTrussStorageStrVal(ParametricTrussRTSam ptUsed)
        {
        ...
        protected void setRecordInMyDataInTrussStorageStrVal(ParametricTrussRTSam ptUsed, string newStr)
        {
        ...
        public void updateOrCreateRecordInMyDataInTrussStorageObj(List<(string, string)> keyValTupList, ParametricTrussRTSam forSelectedTrussOnly = null)
        {
            List<ParametricTrussRTSam> ptList = new List<ParametricTrussRTSam>();
            ...
            foreach (ParametricTrussRTSam ptUsed in ptList)
            {
        ...
        public void updateOrCreateRecordInMyDataInTrussStorageObj(string _key, string _value, ParametricTrussRTSam forSelectedTrussOnly = null)
        {
            updateOrCreateRecordInMyDataInTrussStorageObj(new (string, string)[] { (_key, _value) }.ToList(), forSelectedTrussOnly);
        }

        public IEnumerable<string> recoverFromMyDataFieldAny(string _key, ParametricTrussRTSam ptUsed)
        {
            string _idStr = _key;
        ...
        internal void initializeMyTrussCustom(ParametricTrussRTSam value, bool recoverThisTrussToolImportantGeomValues)
        {
        ...
        internal object restoreMyTrussParamsAfterAction(Func<object> lambda, ParametricTrussRTSam recoverTrussImportantGeomValues)
        {
        ...
        public ParametricTrussRTSam m_ParametricTrussRTSamCurrent
        {
            get
            {
                ...
                return res as ParametricTrussRTSam;
            }
        }

        public ParametricTrussRTSam m_ParametricTrussRTSamOriginal
        {
            get
            {
                PlanarStructure res = null;
        ...
        public ParametricTrussRTSam m_ParametricTrussRTSamFromModelNodes
        {
            get
            {
                PlanarStructure res = this.ModelViewNodes.Where(x => x is ParametricTrussRTSam).FirstOrDefault() as ParametricTrussRTSam;
                //res = this.GetCurrentTruss();
                if (res == null)
                {
                    //res = this.MyTruss;
